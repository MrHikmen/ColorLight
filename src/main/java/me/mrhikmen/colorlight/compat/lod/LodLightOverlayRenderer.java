...
//        matrices.popPose();
//
//        drawFilled(Minecraft.getInstance(), pipeline);
//    }
//
...
//    }
//
//    private static void drawFilled(Minecraft client, RenderPipeline pipeline) {
...
//            }
//
//            vertexBuffer = new MappableRingBuffer(() -> "ColorLight LOD Glow Buffer", GpuBuffer.USAGE_VERTEX | GpuBuffer.USAGE_MAP_WRITE, vertexBufferSize);
//        }
//
...
//                .createRenderPass(() -> "colorlight lod glow", colorTexture, OptionalInt.empty(), mainTarget.getDepthTextureView(), OptionalDouble.empty())) {
//

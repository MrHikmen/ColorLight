        ...
        builder.registerOwnModOptions()
                ...
                .addPage(builder.createOptionPage()
                        ...
                        .addOptionGroup(builder.createOptionGroup()
                                ...
                                .addOption(builder.createBooleanOption(ResourceLocation.parse("colorlight:use_gpu_lighting"))
                                ...
                                .addOption(builder.createBooleanOption(ResourceLocation.parse("colorlight:smooth_lighting"))
        ...
        for (BlockSettings entry : ColorLightClient.config.blocks) {
            ...
            page.addOptionGroup(
                    builder.createOptionGroup()
                            .addOption(builder.createExternalButtonOption(ResourceLocation.parse("colorlight:block_" + block.getPath()))
                                    .setName(Component.translatable("block." + block.toLanguageKey()))
                                    .setTooltip(Translatable.BLOCK_Tooltip)
                                    .setScreenConsumer(parentScreen -> Minecraft.getInstance().setScreen(new ColorLightBlockConfigScreen(parentScreen, entry, this::save)))
                            )
            );
        }
        return page;

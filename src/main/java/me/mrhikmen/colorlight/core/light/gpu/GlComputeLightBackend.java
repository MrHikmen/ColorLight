...
public final class GlComputeLightBackend implements ILightComputeBackend {
    ...
    private static final ResourceLocation SHADER_LOCATION = ResourceLocation.fromNamespaceAndPath("colorlight", "shaders/light_propagate.comp");
    private static final ResourceLocation SMOOTH_SHADER_LOCATION = ResourceLocation.fromNamespaceAndPath("colorlight", "shaders/light_smooth.comp");
    ...
    private int compileProgram(ResourceLocation location, String debugName) throws IOException {
